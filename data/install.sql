...
(32, 'WX_PAY_MCH_ID', 'num', '微信商户ID', 6, '', 'Mch ID是您微信商户的商 户ID，请您妥善保管.', 0, 0, 1, '', 0),
...
(35, 'VOD_TENCENT_SECRETID', 'string', 'SecretID', 9, '', 'SecretID 是您项目的安全密钥', 0, 1664100236, 1, '', 0),
(36, 'VOD_TENCENT_SECRETKEY', 'string', 'SecretKEY', 9, '', 'SecretKEY 是您项目的安全密钥', 0, 1664100208, 1, '', 0),
...
('ED701550-6DFE-62A9-634C-6C2EFC249124', '订阅通知', 'A4650B98-DAD4-8194-030C-1B2AB4F35CBA', 4, 'channel/admin.Account/templateMessage', 0, 0, '', '微信公众号/H5', 0, 'commenting-o ', 'admin'),
...
CREATE TABLE IF NOT EXISTS `muucmf_orders` (
  ...
  `agreed_start_time` int(11) UNSIGNED NOT NULL COMMENT '约定开始时间戳',
  `agreed_end_time` int(11) UNSIGNED NOT NULL COMMENT '约定结束时间戳',
  `create_time` int(11) UNSIGNED NOT NULL COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
