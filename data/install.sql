...
(3, 'PICTURE_UPLOAD_DRIVER', 'select', '图片上传驱动', 'store', 'tencent:腾讯云COS\r\naliyun:阿里云OSS', '', 0, 1649315854, 1, 'local', 0),
...
(32, 'WX_PAY_MCH_ID', 'num', '微信商户ID', 'weixinpay', '', 'Mch ID是您微信商户的商 户ID，请您妥善保管.', 0, 0, 1, '', 0),
(33, 'WX_PAY_KEY_SECRET', 'string', '微信商户API密钥', 'weixinpay', '', 'Key Secret是您微信商户的API密钥，请您妥善保管.', 0, 0, 1, '', 0),
(34, 'VOD_UPLOAD_DRIVER', 'select', '云点播上传驱动', 'vod', '', '云点播上传驱动', 0, 0, 1, 'disable', 0),
...
(43, 'WX_PAY_CERT', 'string', '微信支付cert证书', 'weixinpay', '', '', 0, 0, 1, '', 0),
(44, 'WX_PAY_KEY', 'string', '微信支付Key证书', 'weixinpay', '', '', 0, 0, 1, '', 0),
