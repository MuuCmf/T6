...
CREATE TABLE IF NOT EXISTS `muucmf_adv_pos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='广告位置表';
...
CREATE TABLE IF NOT EXISTS `muucmf_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='广告表';
...
('164', '用户标签列表', '2', 7, 'admin/UserTag/userTag', 0, 0, '', '用户管理', 0, 'tags', ''),
...
('39', '扩展资料', '2', 6, 'admin/User/profile', 0, 0, '', '用户管理', 0, 'expand', ''),
