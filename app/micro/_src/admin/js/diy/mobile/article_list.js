...
$(function(){
    ...
    //分类数据接口
    var category_api = $('.btn-object[data-type="article_list"]').data('category-api');
    //列表加载初始数据
	...
	//点击显示文章列表控制区
	$('.page-diy-section').on("click",'[data-type="article_list"]',function(){
		//已经显示的不再触发
    ...
    **/
     ...
     */
    $('.page-diy-section .object-lists').on("click",'.btn-object[data-type="article_list"]',function(){
