...
$(function(){
    ...
    //分类数据接口
    var category_api = $('.btn-object[data-type="column_list"]').data('category-api');
    //课程列表加载初始数据
	...
	//点击显示列表控制区
	$('.page-diy-section').on("click",'[data-type="material_list"]',function(e){
     ...
     */
    $('.page-diy-section .object-lists').on("click",'.btn-object[data-type="material_list"]',function(){
        ...
        //获取初始列表数据
        material_list_loader(2,'create_time','ASC',0,1,0,'[data-object-index='+object_index+']');
