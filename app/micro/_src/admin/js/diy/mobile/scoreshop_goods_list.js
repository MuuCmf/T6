$(function(){
    ...
    //分类数据接口
    var category_api = $('.btn-object[data-type="scoreshop_list"]').data('category-api');
    //列表加载初始数据
    let scoreshop_goods_list_loader = function(rows=2, order_field= 'create_time', order_type= 'DESC', type= 'all', category_id= 0, rank = 1, element){
    ...
    //点击显示积分商品列表控制区
    $('.page-diy-section').on("click",'[data-type="scoreshop_goods_list"]',function(e){
        ...
        $('.page-diy-section').on('click','[data-object-index="'+object_index+'"] .btn',function(){
            ...
            //console.log(rank);
            //执行重新加载ajax数据
            scoreshop_goods_list_loader(rows,order_field,order_type,type,category_id,rank,'[data-object-index='+object_index+']');
        });
     ...
     */
    $('.page-diy-section .object-lists').on("click",'.btn-object[data-type="scoreshop_goods_list"]',function(){
        ...
        $.get(url, function($res){
            ...
            if($res.code == 200){
                ...
                scoreshop_goods_list_loader(2,'create_time','ASC','all',0,1,'[data-object-index='+object_index+']');
                //}
            }else{
