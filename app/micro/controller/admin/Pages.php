...
use app\classroom\controller\admin\Admin as ClassroomAdmin;
use app\classroom\model\ClassroomCategory as CategoryModel;
use app\common\model\Page as PageModel;
use app\classroom\logic\Page as PageLogic;
use think\facade\View;

class Page extends ClassroomAdmin
{
    protected $PageLogic;
    protected $PageModel;
