...
## 前后端分离
提供独立的前端项目 MuuCmf Admin Frontend，采用现代前端技术栈开发，支持更灵活的项目部署和开发体验

* Github https://github.com/MuuCmf/MuuCmf-admin-frontend
* Gitee https://gitee.com/dameng100/muucmf-admin-frontend
...
#### 产品介绍
Muu+系列应用，是基于MuuCmf T6开源框架开发的一款渐进式轻应用的矩阵。您可以通过自由组合应用模块，来形成独特的运营模式。支持点播课、直播、专栏、商城、线下活动、分销、题库考试、资料下载、线下课等功能。低代码/无代码DIY设计理念，让开发者用最低的成本、最快捷的搭建平台。您也可以基于MuuCmf T6开源框架二开新功能，可实现与Muu+系列应用完全打通。

## 产品部分功能展示

#### 提供三种主题风格

![传统蓝](https://www.muucmf.cc/custom/blue_theme.png "前台首页截图")

![亮色](https://www.muucmf.cc/custom/light_theme.png "前台首页截图")

![暗黑](https://www.muucmf.cc/custom/dark_theme.png "前台首页截图")
