...
<div class="main">
  <div class="text-box" id="text-box">
    <div class="license">
      <h1>MuuCmf T6 安装协议</h1>
      <p>感谢您选择本系统。本系统是自主开发，低代码应用开发框架及多应用整合解决方案。官方网址为 {$site_url}。</p>
      ...
      <ol>
        ...
        <li>您可以在协议规定的约束和限制范围内修改{$site_name}系统源代码(如果被提供的话)或界面风格以适应您的系统需求。</li>
        <li>您拥有使用本软件构建的全部会员资料、文章、商品及相关内容的所有权，并独立承担与使用本软件构建的网站内容的审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用{$site_name}系统和服务带来的全部责任，若造成{$site_name}或用户损失的，您应予以全部赔偿。</li>
        <li>本协议是您与{$site_company}之间关于您安装使用本公司提供的{$site_name}系统及服务的法律协议，若您需将{$site_name}系统或服务用于商业用途，必须另行获得{$site_name}的授权许可，您在获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权利，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</li>
      </ol>
      <p></p>
      <h3>II. 协议规定的约束和限制</h3>
      <ol>
